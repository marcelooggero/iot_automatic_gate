 ...
 *   20/10/2021 Final Version 1.0.0
 *   
 *************************************************************************/
...
/////////////////////////////////////////////////////////////////////////////////////////FIN PARA WIFIMANAGER
  ...
  timer.setInterval(100L, switchOffGPIO4);
   cuentaTimer = 0;
}
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
//                                                    FIN SETUP
...
void switchOffGPIO4() //This function reads the input and after 5 times the timer disable the output (with this approach you ensure always a pulse between 4 and 5 times the timer)
{
  if(digitalRead(ESP8266_GPIO4) == HIGH){
      if(cuentaTimer>=5){
...
void loop() {
  Blynk.run();
  timer.run(); //timer to switchOffGPIO4
}
